...
void read_simulated_registers(int16_t* temperature, int16_t* voltage) {
	if (temperature) *temperature = simulated_temperature;	// Return simulated temperature
	if (voltage) *voltage = simulated_voltage;				// Return simulated voltage
}
// ------------------------------[ SET SIMULATED REGISTERS ]------------------------------
void set_simulated_registers(int16_t temperature, int16_t voltage) {	// Set simulated sensor data
	simulated_temperature = temperature;								// Set simulated temperature
	simulated_voltage = voltage;										// Set simulated voltage
}
// ------------------------------[ END OF FILE ]------------------------------